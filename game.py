...
def game():
    ...
    def move(*args):
        ...
        if dessin.coords(balle1)[3] < 10:
            ...
            random_number = [2, -2, 0]
            random_direction = choice(random_number)
    ...
    btn_start = Button(int, text="LANCER", bg="gray", fg="black", command=move, relief="flat", borderwidth=0, font=("yellowstone", 20), width=10)
    btn_start.bind("<<space>>", move)
    btn_start.pack()
